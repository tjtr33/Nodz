#16feb2022 this file is clean
########################### done ##############################
#14feb2022 
# DONE add file name 'L'oaded to title bar, ( at app opening title is "Nodz4Hal"
#11feb DONE re: menu   use a text file brought up by m or M keys
#14feb DONE in loadGraph  set some visual hint about data type
...
#
############################# todo ######################### 
# TESTING the default_config.json still has width & height
#   is this used? Yes is it a problem? NO can it be removed? DUNNO
#   on 14feb was   "scene_width": 3802,
#                  "scene_height": 1084,
#   on 14feb chgd to 1024,768  no ill effects seen
# DONE width height are needed in default_config.json'
#  fir the innitial window size ( there has to be SOME dimensions)
#  so LEAVE AS IS ( they get overrode in 1st 'L'oad )
#
# TESTING when 'L'oading, select all then Focus, then desel all
#
# TESTING  the 'calcscale()' code is rem'd out
#   I factored the old code out,
#   wrote new func , then found rtn value never used, so rem'd out
#   i see no probs with zoom , Load and load so TESTING status
#
...
#   and process according to extent (.graph vs .view possibly)
#
# TODO save w,h somewhere 
#   what i DO is call loadGraph() when processing Key_S
#   just to get w,h

# TODO is _getSelectionBoundingbox used? YES in _focus()
...
#   is the '12' necc? (looks like text ht, if so, set using textHt )
#   the 12 maybe useful just to keep topmost nodes off top edge
#
# TODO allow for 'io' pins   hahaha  
#
...
#
# TODO tool to easily flip cnxnSide
#
# TODO tool to easily raise or lower a plug/socket slot(maybe use 'index')
#
# TODO tool to add alternate fqfn and media type
#
# TODO in createNode
...
#    maybe if is none ??
####################### future wishlist ########################
# TODO 07feb re making a gui for creating hal files...
...
nodz.initialize()
#14feb try to name the window  later use 'L'oaded filename
# that just worked !
nodz.setWindowTitle("Nodz4Hal")
nodz.show()
